...
- **Folder tree reference:** use the latest `docs-internal/folder-tree_*.md` snapshot (resolve with `docs-internal/skills/sinlesscsb-context/scripts/select-latest-folder-tree.ps1 -PruneTracked`) to route Create/Import JSON macros and locate content by folder.
